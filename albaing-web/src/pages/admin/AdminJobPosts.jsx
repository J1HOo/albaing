    ...
    return (
        <div className="flex">
            ...
            <div className="flex-1 max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md border border-gray-300">
                <h2 className="text-3xl font-semibold text-center text-gray-800 mb-12">채용 공고 관리</h2>
                ...
                <div className="mb-12 flex justify-end space-x-4">
                    ...
                    <input
                        ...
                        placeholder="공고 상태"
                        value={jobPostStatus}
                        onChange={(e) => setJobPostStatus(e.target.value)}
                        className="px-4 py-1.5 border rounded-md w-1/3"
                    />
                    <button
                ...
                <table className="min-w-full table-auto">
                    ...
                    <tr className="border-b border-gray-300">
                        ...
                        <th className="px-6 py-3 text-left text-gray-700 font-semibold">공고상태</th>
